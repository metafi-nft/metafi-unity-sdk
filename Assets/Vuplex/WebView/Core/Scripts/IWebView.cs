...
namespace Vuplex.WebView {
    ...
    public interface IWebView {
        ...
        /// </summary>
        /// <remarks>
        /// Almost all of the 3D WebView packages support transparent webviews, but there are two exceptions: <br/>
        /// - 3D WebView for Android with Gecko Engine doesn't support transparency because the mobile Gecko browser engine doesn't currently support it.

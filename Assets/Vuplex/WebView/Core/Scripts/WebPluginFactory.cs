...
namespace Vuplex.WebView {
    ...
    public class WebPluginFactory {
        ...
        public virtual IWebPlugin GetPlugin(WebPluginType[] preferredPlugins) {
                ...
                throw new WebViewUnavailableException("The 3D WebView for Windows plugin is not currently installed." + _getMoreInfoText("windows-mac"));
            #elif UNITY_STANDALONE_OSX
                if (_macPlugin != null) {
                    return _macPlugin;
                }
                throw new WebViewUnavailableException("The 3D WebView for macOS plugin is not currently installed." + _getMoreInfoText("windows-mac"));
            #elif UNITY_IOS
                if (_iosPlugin != null) {
                    return _iosPlugin;
                }
                throw new WebViewUnavailableException("The 3D WebView for iOS plugin is not currently installed." + _getMoreInfoText("ios"));
            #elif UNITY_ANDROID
                ...
                throw new WebViewUnavailableException("The 3D WebView for Android plugin is not currently installed." + _getMoreInfoText("android"));
            #elif UNITY_WSA
                if (_uwpPlugin != null) {
                    return _uwpPlugin;
                }
                throw new WebViewUnavailableException("The 3D WebView for UWP plugin is not currently installed." + _getMoreInfoText("uwp"));
            #elif UNITY_WEBGL
                if (_webGLPlugin != null) {
                    return _webGLPlugin;
                }
                throw new WebViewUnavailableException("The 2D WebView for WebGL plugin is not currently installed." + _getMoreInfoText("webgl"));
            #else
                throw new WebViewUnavailableException("This version of 3D WebView does not support the current platform. For more info, please visit https://developer.vuplex.com .");
            #endif
        }
